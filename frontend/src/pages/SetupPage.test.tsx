...
describe('SetupPage', () => {
  beforeEach(() => {
    ...
    mockedApi.getSettings.mockResolvedValue({
      ...
      provider: 'deepseek',
      providers: [
        { id: 'deepseek', name: 'DeepSeek', base_url: 'https://api.deepseek.com', requires_key: true, is_custom: false, models: ['deepseek-chat'] },
        { id: 'ollama', name: 'Ollama（本地）', base_url: 'http://127.0.0.1:11434/v1', requires_key: false, is_custom: false, models: ['qwen2.5'] },
      ],
      model: 'deepseek-chat',
